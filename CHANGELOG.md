...
[0.8.2]: https://github.com/grobertson/kryten-api-gate/compare/v0.8.1...v0.8.2

## [0.8.1] - 2026-07-04

### Removed

- **`/api/v1/moderation/*` endpoints** (kick, ban, mute, shadow-mute, unmute, assign-leader, banlist, unban) — superseded by the kryten-moderator integration added in 0.8.0. Removed the `moderation` route module and all associated API reference documentation.

[0.8.1]: https://github.com/grobertson/kryten-api-gate/compare/v0.8.0...v0.8.1
